...
<h1 id="bienvenu"> Inscription </h1>
<div class="milieu1"> 
<div class="gauche"> 
<img src="../style/img/m2.jpg" class="image1">
</div>
<div class="droite"> 
<form action="../connexion/signin" method="POST">
  <div class="form-group">
    <input type="text" name="nom" required class="form-control champ" id="exampleFormControlInput1" placeholder="Nom" required>
  </div>
  <div class="form-group">
    <input type="text" name="prenom" required class="form-control champ" id="exampleFormControlInput1" placeholder="Prenom" required>
  </div>
  <div class="form-group">
 ...
 <span class="errMsg"><?= $erreur?> </span>
 <span><?= $connect?> </span>
  <div class="sbouton1">
    <input id="sendTuteurs" type="submit" value="Envoyer" name="valider"class="btn btn-outline-primary sbouton2">
    <button class="btn btn-outline-primary sbouton2"> <a href="../formulaire/login">Annuler</a>  </button>  
  </div>
</form>
</div>   
</div>
